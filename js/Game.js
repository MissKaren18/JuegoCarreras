class Game {
  constructor() {
    ...
    //3. se crea la propiedad
    this.playerMoving = false;
    //4. cambiar a true cuando el carro se mueve handlePlayerControl()
  }
...
/**************INTELIGENCIA ARTIFICIAL***************** */
  ...
  //1. se crea una funcion similar para la barra de gasolina cambiar los valores de y
  showFuelBar() {
    push();
  ...
  //2. verificar si el auto esta en movimiento en el constructor
  ...
  handlePlayerControls() {
    if (keyIsDown(UP_ARROW)) {
      ...
      //6. se agrega una condiciones en handleFuel().
      player.positionY += 10;
      player.update();
    }
  ...
  handleFuel(index) {
    ...
    //7.  Reducir el combustible del auto
  ...
  //9. se crea el metodo para mandar un mensaje de fin de juego
  gameOver() {
    swal({
      title: `Fin del juego`,
